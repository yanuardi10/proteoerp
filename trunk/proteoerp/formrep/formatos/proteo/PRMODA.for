...
<title>Registro de deposito en nuestras cuentas no aplicados <?php echo $numero ?></title>
...
<div style="width: 100%; text-align:center;">
	<table  class="header" style="width: 100%;">
		<tr>
			<td valign='bottom'><h1 style="text-align: left">REGISTRO DE DEP&Oacute;SITOS EN NUESTRAS CUENTAS NO APLICADOS No. <?php echo $numero; ?></h1></td>
	...
	<table width='90%' align='center' style="font-size: 8pt;">
		...
		<tr>
			<td colspan="2">
				<table width="100%">
					<tr>
						<td style="text-align: center;" ><b>Nombre del banco: </b><?php echo $banco; ?></td>
						<td style="text-align: center;" ><b>Cuenta: </b><?php echo $numcuent; ?></td>
						<td style="text-align: center;" ><b>Dep&oacute;sito o N.C. Nro.: </b><?php echo $numche; ?></td>
					</tr>
				</table>
			</td>
		</tr>
