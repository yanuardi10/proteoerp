...
,'a.nombre','CONCAT_WS(\' \',TRIM(a.observa1),a.observa2) AS observa','a.transac','b.tbanco','b.numcuent');
$this->db->select($sel);
$this->db->from('prmo AS a');
$this->db->join('banc AS b','a.codban=b.codbanc');
$this->db->where('a.tipop' , '1');
...
<title>Prestamo otorgado <?php echo $numero ?></title>
...
<div style="width: 100%; text-align:center;">
	<table  class="header" style="width: 100%;">
		<tr>
			<td valign='bottom'><h1 style="text-align: left">PRESTAMO OTROGADO  No. <?php echo $numero; ?></h1></td>
...
<div style="width: 100%; text-align:center;">
	<table align='center' style="font-size: 8pt;">
		<tr>
			<td style="text-align: right;"><b>Otorgado a:</b></td>
		...
		<tr>
			<td style="text-align: right;"><b>Para cancelar en:</b></td>
			<td style="text-align:  left;" ><?php echo $cuotas; echo ($cuotas>1)? ' CUOTAS':' CUOTA'; ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align: center;font-size:2.2em; border-bottom-style:solid; border-top-style:solid;border-width:1px;" colspan='2'><b>Por un monto de: <?php echo $monto; ?> Bs.</b></td>
		</tr>
		<tr>
			<td colspan="2">
				<table width="100%">
					<tr>
						<td style="text-align: center;" ><b>Pagado por: </b><?php echo $banco; ?></td>
						<td style="text-align: center;" ><b>Cuenta: </b><?php echo $numcuent; ?></td>
						<td style="text-align: center;" ><b>Nota nro.: </b><?php echo $numche; ?></td>
					</tr>
				</table>
			</td>
		</tr>
