...
function refreshVitals(xml) {
    ...
    $("Vitals", xml).each(function getVitals(id) {
        ...
        $("#s_distro").html("<img src='<?php echo $imag; ?>images/" + icon + "' alt='Icon' height='16' width='16' style='vertical-align:middle;' />&nbsp;" + distro);
...
function refreshHardware(xml) {
    ...
    $("#HardwareTree").jqTreeTable(tree, {
        openImg: "<?php echo $imag; ?>treeTable/tv-collapsable.gif",
        shutImg: "<?php echo $imag; ?>treeTable/tv-expandable.gif",
        leafImg: "<?php echo $imag; ?>treeTable/tv-item.gif",
        lastOpenImg: "<?php echo $imag; ?>treeTable/tv-collapsable-last.gif",
        lastShutImg: "<?php echo $imag; ?>treeTable/tv-expandable-last.gif",
        lastLeafImg: "<?php echo $imag; ?>treeTable/tv-item-last.gif",
        vertLineImg: "<?php echo $imag; ?>treeTable/vertline.gif",
        blankImg: "<?php echo $imag; ?>treeTable/blank.gif",
        collapse: closed,
        column: 0,
        striped: true,
        highlight: false,
...
function buildBlock(plugin, translationid, reload) {
    var block = "", reloadpic = "";
    if (reload) {
        reloadpic = "<img id=\"Reload_" + plugin + "Table\" src=\"<?php echo $imag; ?>reload.png\" alt=\"reload\" style=\"vertical-align:middle;border=0px;\" />&nbsp;";
    }
