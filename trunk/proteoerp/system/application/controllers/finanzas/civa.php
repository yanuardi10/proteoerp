...
jQuery("#a1").click( function(){
	...
	if (id)	{
		...
		window.open(\'/proteoerp/formatos/ver/CIVA/\'+id, \'_blank\', \'width=800,height=600,scrollbars=yes,status=yes,resizable=yes,screenx=((screen.availHeight/2)-400), screeny=((screen.availWidth/2)-300)\');
