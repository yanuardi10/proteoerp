...
class Forma1 extends Controller{
	 ...
	 *
	 * */
	function agrega_col($camp,$name,$pos,$tam=0,$alinea="",$tfuen,$estilo="",$fillColor=0,$tdato='',$reseth=true,$stretch = 0,$autopadding = true,$valign = 'T',$border='T',$height=4){
		...
		$this->columnas[]=array('campo'=>$camp,'titulo'=>$name,'pos'=>$pos,
								...
								'autopadding'=>$autopadding,'valign'=>$valign,'height'=>$height);
	}
	/*
