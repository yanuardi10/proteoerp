...
class Grpr extends Controller {
	...
	function index(){
		...
		$this->datasis->modintramenu( 480, 500, substr($this->url,0,-1) );
	...
	function defgrid( $deployed = false ){
		...
		$grid->setFormOptionsA('closeAfterAdd:false, mtype: "POST", width: 400, height:200, closeOnEscape: true, top: 50, left:20, recreateForm:true, afterSubmit: function(a,b){if (a.responseText.length > 0) $.prompt(a.responseText); return [true, a ];},afterShowForm: function(frm){$("select").selectmenu({style:"popup"});} ');
