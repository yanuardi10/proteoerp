...
class lhojadetrabajo extends Controller {
	...
	function index() {
		...
		$obj = new mtable("Listado de Hoja de Trabajo p/toma de Inventario F&iacute;sico",8);
		$obj->AddPage();
		$obj->AddCol('codigo' ,20, 'C&oacute;digo', 'L',6);
		$obj->AddCol('grupo'  ,10, 'Grupo', 'C',6);
		$obj->AddCol('descrip',125,'Descripci&oacute;n', 'L',6);
