		...
		<td colspan='2'>
			...
			<table style="height: 100%;width: 100%" >
				<tr>
					...
					<td class="littletablerow" colspan='2'>    <?=$form->rica->output  ?></td>
				</tr>
				<tr>
					<td class="littletableheaderc"><?=$form->reten->label  ?></td>
					<td class="littletablerow">    <?=$form->reten->output ?></td>
					<td class="littletableheaderc"><?=$form->retej->label  ?></td>
					<td class="littletablerow">    <?=$form->retej->output ?></td>
				</tr>
			</table>
			</fieldset>
		</td>
