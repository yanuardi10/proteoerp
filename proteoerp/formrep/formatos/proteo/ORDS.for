...
$mSQL_1 = $this->db->query('SELECT a.fecha,a.numero,a.proveed,
	a.nombre,
	a.totpre AS totals,
	a.totiva AS iva,
	a.totbruto AS totalg,
...
$lineas   = 0;
$uline    = array();
$mSQL_2   = $this->db->query('SELECT codigo,descrip AS desca,precio AS preca,iva,importe FROM itords WHERE numero='.$dbnumero);
$detalle  = $mSQL_2->result();
?><html>
<head>
<meta http-equiv="Content-type" content="text/html; charset=<?php echo $this->config->item('charset'); ?>" >
<title>Orden de Servicio <?php echo $numero ?></title>
...
$encabezado = <<<encabezado
	<table style="width: 100%;" class="header">
		<tr>
			<td valign='bottom'><h1 style="text-align: left">Orden de servicio</h1></td>
			...
			<td colspan='2' style="text-align: center">Solicitamos de ustedes los siguiente:</td>
		</tr>
	</table>
encabezado;
// Fin  Encabezado
	...
	<table class="change_order_items">
		<thead>
			<tr>
				...
				<th style='color: #111111;background: #EEEEEE;border: 1px solid black;font-size: 8pt;' >Monto</th>
				<th style='color: #111111;background: #EEEEEE;border: 1px solid black;font-size: 8pt;' >Impuesto</th>
...
?>
			<tr class="<?php if(!$mod) echo 'even_row'; else  echo 'odd_row'; ?>">
				...
				<td style="text-align: center;"><?php    echo ($clinea)? '': nformat($items->preca);  ?></td>
