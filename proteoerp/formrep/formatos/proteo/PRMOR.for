...
<title>Pr&eacute;stamo recibido <?php echo $numero ?></title>
...
<div style="width: 100%; text-align:center;">
	<table  class="header" style="width: 100%;">
		<tr>
			<td valign='bottom'><h1 style="text-align: left">PR&Eacute;STAMO RECIBIDO  No. <?php echo $numero; ?></h1></td>
...
<div style="width: 100%; text-align:center;">
	<table align='center' style="font-size: 8pt;">
		<tr>
			<td style="text-align: right;"><b>Recibido de:</b></td>
		...
		<tr>
			<td style="text-align: center;font-size:2.2em; border-bottom-style:solid; border-top-style:solid;border-width:1px;" colspan='2'><b>Monto de pr&eacute;stamo: <?php echo $monto; ?> Bs.</b></td>
		</tr>
	</table>
</div>
<br>
