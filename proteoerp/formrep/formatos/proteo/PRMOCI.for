...
<title>Registro de nota de d&eacute;bito en banco por reclamar <?php echo $numero ?></title>
...
<div style="width: 100%; text-align:center;">
	<table  class="header" style="width: 100%;">
		<tr>
			<td valign='bottom'><h1 style="text-align: left">REGISTRO DE NOTA DE D&Eacute;BITO EN BANCO POR RECLAMAR No. <?php echo $numero; ?></h1></td>
	...
	<table width='90%' align='center' style="font-size: 8pt;">
		...
		<tr>
			<td style="text-align: center;font-size:2.2em; border-bottom-style:solid; border-top-style:solid;border-width:1px;" colspan='2'>
				<b>Monto de la nota de d&eacute;bito: <?php echo $monto; ?> Bs.</b>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<table width="100%">
					<tr>
						<td style="text-align: center;" ><b>Cargo del banco: </b><?php echo $banco; ?></td>
						<td style="text-align: center;" ><b>Cuenta: </b><?php echo $numcuent; ?></td>
						<td style="text-align: center;" ><b>Nota de d&eacute;bito nro.: </b><?php echo $numche; ?></td>
					</tr>
				</table>
			</td>
		</tr>
