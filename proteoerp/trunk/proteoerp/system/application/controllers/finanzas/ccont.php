...
class ccont extends Controller {	
	...
	function index() {		
		...
		$filter->ffechah->group=$filter->ffechad->group="Fecha de Terminación";
		...
		$filter->nombre = new inputField("Nombre o Razón Social","nombre");
	...
	function dataedit(){
		...
		$edit->nombre = new inputField("Nombre o Razón Social","nombre");
		$edit->nombre->size=50;
		$edit->nombre->maxlength =100;
		$edit->nombre->rule = 'required|strtoupper';
		
		$edit->direccion = new textareaField("Dirección o Domicilio","direccion");
    ...
    $edit->tota  = new inputField("Total Bs", "tota");
		...
		$edit->fecha_final->rule='chfecha';
		$edit->fecha_final->rule = 'required';
