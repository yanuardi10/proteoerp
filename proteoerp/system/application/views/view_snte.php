	...
	<tr>
		...
		<table width="100%" style="margin: 0; width: 100%;">
			...
			<tr>
				...
				<td class="littletablerow"colspan='1'>   <?php echo $form->cliente->output,$form->sclitipo->output,$form->nombre->output; ?>&nbsp;</td>
			...
			<tr>
				...
				<td class="littletablerow" colspan='2'><?php echo $form->dir_cli->output ?>&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="littletableheader"><?=$form->factura->label  ?>&nbsp;</td>
				<td class="littletablerow" align="left"><?=$form->factura->output ?>&nbsp;</td>
				<td class="littletableheader"><?php echo $form->almacen->label     ?>&nbsp;</td>
				<td class="littletablerow">   <?php echo $form->almacen->output    ?>&nbsp;</td>
			</tr>
			<tr>
				<td class="littletableheader"><?=$form->orden->label  ?>&nbsp;</td>
				<td class="littletablerow" align="left"colspan='4'><?=$form->orden->output ?>&nbsp;</td>
			</tr>
		</table><br>
		</td>
	</tr>
