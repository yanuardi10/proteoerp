	...
	<tr>
      ...
      <table  width="100%" style="margin:0;width:100%;" >
	    <tr bgcolor="#545294">                                                           
	     ...
	     <tr bgcolor="#717394">   
				<td class="littletablerow" a align="left" ><input name="codigoa[]"  type="text"  value="<?=$items->codigoa ?>"  readonly="false"/></td>
			    ...
			    <?=$items->tota ?>
           		...
           		<td align="right" bgcolor="#2067B5" class="littletablerow" a><input name="ultidespachado[]" type="text"  value="" size="11"/> </td>
					<td align="right" bgcolor="#2067B5" class="littletablerow" a><input name="cdespacha[]" type="text"  value="<?=$items->cdespacha ?>" size="11" readonly="false"/> </td>
