...
class Lpago extends Controller {
	...
	function index(){
		...
		$this->datasis->creaintramenu(array('modulo'=>'225','titulo'=>'Pagos de Producción','mensaje'=>'Pagos de Producción','panel'=>'LECHE','ejecutar'=>'leche/lpago','target'=>'popu','visible'=>'S','pertenece'=>'2','ancho'=>900,'alto'=>600));
