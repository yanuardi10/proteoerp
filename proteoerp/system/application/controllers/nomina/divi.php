...
jQuery("#a1").click( function(){
	...
	if (id)	{
		...
		window.open(\'/proteoerp/formatos/ver/DIVI/\'+id, \'_blank\', \'width=800,height=600,scrollbars=yes,status=yes,resizable=yes,screenx=((screen.availHeight/2)-400), screeny=((screen.availWidth/2)-300)\');
...
';
	...
	function defgrid( $deployed = false ){
		...
		$grid->setFormOptionsE('closeAfterEdit:true, mtype: "POST", width: 420, height:150, closeOnEscape: true, top: 50, left:20, recreateForm:true, afterSubmit: function(a,b){if (a.responseText.length > 0) $.prompt(a.responseText); return [true, a ];} ');
		$grid->setFormOptionsA('closeAfterAdd:true,  mtype: "POST", width: 420, height:150, closeOnEscape: true, top: 50, left:20, recreateForm:true, afterSubmit: function(a,b){if (a.responseText.length > 0) $.prompt(a.responseText); return [true, a ];} ');
